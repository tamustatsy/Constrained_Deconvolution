...
# b_lap: vector of standard deviation(s) for the measurement error,  #
...
ddsc_mcmc <- function(w, b_lap, n.burnin, n.MCMC, n, K, m, lambda, parMH = 2, 
    ...
    #the cutoff for U_i is [- \theta_i - W_i, \theta_i - W_i]                  #
    #generate uniform variable between Lap(-\theta_i - W_i),Lap(\theta_i - W_i)#
